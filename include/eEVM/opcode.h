...
namespace eevm
{
    ...
    enum Opcode : uint8_t
    {
        ...
        ORIGIN = 0x32, //  Get execution origination address (This is the sender of
                       //  original transaction; it is never an account with
                       //  non-emptyassociated code.)
        CALLER = 0x33, // Get caller address (This is the address of the account
                       // that is directly responsible for this execution.)
        CALLVALUE = 0x34, // Get deposited value by the instruction/transaction
                          // responsible for this execution.
        CALLDATALOAD = 0x35, // Get input data of current environment. (This
                             // pertains to the input data passed with the message
                             // call instruction or transaction.)
        CALLDATASIZE = 0x36, // Get size of input data in current environment (This
                             // pertains to the input data passed with the message
                             // call instruction or transaction.)
        ...
        GASPRICE = 0x3a, //  Get price of gas in current environment. (This is gas
        ...
        GAS = 0x5a, // Get the amount of available gas, including the corresponding
